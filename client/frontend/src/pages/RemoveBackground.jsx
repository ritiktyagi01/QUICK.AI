      ...
      <div className='h-auto overflow-y-scroll p-6'>
        <div className='mx-60 flex items-start flex-wrap gap-6 text-slate-600'>
          ...
          {error && (
            ...
            {/* Submit Button */}
            <button type='submit' className='mt-6 w-full bg-linear-to-l from-[#FF4938] to-[#FF4938] text-white p-2 rounded-md hover:bg-red-700 transition-colors cursor-pointer'>
